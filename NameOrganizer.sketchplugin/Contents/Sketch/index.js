...
var arrayReduce = __webpack_require__(81),
    deburr = __webpack_require__(82),
    words = __webpack_require__(86);
...
if (true) {
  var sketchUtils = __webpack_require__(100)
...
exports.addNumber = exports.removeNumber = undefined;

var _drop2 = __webpack_require__(185);
...
var removeNumber = function removeNumber(Artboards, option) {
  console.log('Remove Num Start', option);
  (0, _forEach3.default)(Artboards, function (layer) {
...
var addNumber = function addNumber(Artboards, option) {
  console.log('Add Num Start', option);
  (0, _forEach3.default)(Artboards, function (layer, index) {
    console.log('before', layer.name);
...
function remove(name, option) {
  return (0, _drop3.default)(name.split(option)).join(option);
}
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(23)))
...
var _sketchModuleWebView = __webpack_require__(53);

var _sketchModuleWebView2 = _interopRequireDefault(_sketchModuleWebView);

var _utils = __webpack_require__(56);

var _rename = __webpack_require__(79);

var _rename2 = _interopRequireDefault(_rename);

var _sortLayer = __webpack_require__(99);

var _sortLayer2 = _interopRequireDefault(_sortLayer);
...
exports.default = function (context) {
  ...
  var panelID = 'sketch-name-organizer.panel';

  var _mapLayers = (0, _utils.mapLayers)(document.selectedPage),
      All = _mapLayers.All,
      Artboards = _mapLayers.Artboards;
  ...
  var panelUI = new _sketchModuleWebView2.default(context, Panel, {
    identifier: panelID,
    x: 0,
    y: 0,
    width: 340,
    ...
    background: (0, _utils.hex2NSColor)('83FFBB'),
    hideTitleBar: false,
    shouldKeepAround: true,
    resizable: false,
    handlers: {
      onRun: function onRun(callback) {
        if (All.length === 0) return _ui2.default.alert('🖌 Name Organizer', 'No Layer found ...');

        var config = JSON.parse(callback);
        if (config.addNumChecked) (0, _number.removeNumber)(Artboards, config.addNum);

        if (config.renameSwitch) (0, _rename2.default)(All, {
          handleSymbol: config.handleSymbolChecked,
          format: config.format,
          space: config.handleSymbolChecked
        });

        if (Artboards.length === 0) return _ui2.default.alert('🖌 Name Organizer', 'No Artboard found ...');
        (0, _sortLayer2.default)(Artboards, {
        ...
        _ui2.default.message('\uD83D\uDD8C Name Organizer: Done !');
      },
      onRemove: function onRemove(callback) {
        if (Artboards.length === 0) return _ui2.default.alert('🖌 Name Organizer', 'No Artboard found ...');
        var config = JSON.parse(callback);
        if (config.addNum !== '') {
          (0, _number.removeNumber)(Artboards, config.addNum);
        } else {
          return _ui2.default.alert('🖌 Name Organizer', 'Order Number style is not set.');
        }
        _ui2.default.message('\uD83D\uDD8C Name Organizer: Removed !');
      },
...
var MochaJSDelegate = __webpack_require__(54)
var parseQuery = __webpack_require__(55)
...
var _mapLayers = __webpack_require__(57);
...
var _hex2NSColor = __webpack_require__(77);
...
var _openURL = __webpack_require__(78);
...
var _startCase2 = __webpack_require__(80);

var _startCase3 = _interopRequireDefault(_startCase2);

var _snakeCase2 = __webpack_require__(95);

var _snakeCase3 = _interopRequireDefault(_snakeCase2);

var _kebabCase2 = __webpack_require__(96);

var _kebabCase3 = _interopRequireDefault(_kebabCase2);

var _camelCase2 = __webpack_require__(97);

var _camelCase3 = _interopRequireDefault(_camelCase2);

var _upperFirst2 = __webpack_require__(22);
...
exports.default = function (AllLayers) {
  ...
  (0, _forEach3.default)(AllLayers, function (layer) {
    if (option.handleSymbol && layer.master) {
      var newName = formatName(layer.master.name, option.format, option.space);
...
function formatName(name, format, space) {
  var Name = name.replace(/([ ]+|)\/([ ]+|)/g, '/').split(/\//g);
  (0, _forEach3.default)(Name, function (str, i) {
    switch (format) {
      case 'CamelCase':
        Name[i] = (0, _upperFirst3.default)((0, _camelCase3.default)(str));
        break;
      case 'camelCase':
        Name[i] = (0, _camelCase3.default)(str);
        break;
      case 'kebabCase':
        Name[i] = (0, _kebabCase3.default)(str);
        break;
      case 'snakeCase':
        Name[i] = (0, _snakeCase3.default)(str);
        break;
      case 'startCase':
        Name[i] = (0, _startCase3.default)(str);
        break;
    }
  });
...
var createCompounder = __webpack_require__(12),
    upperFirst = __webpack_require__(22);
...
var deburrLetter = __webpack_require__(83),
    toString = __webpack_require__(8);
...
var basePropertyOf = __webpack_require__(84);
...
var asciiWords = __webpack_require__(87),
    hasUnicodeWord = __webpack_require__(88),
    toString = __webpack_require__(8),
    unicodeWords = __webpack_require__(89);
...
var castSlice = __webpack_require__(91),
    hasUnicode = __webpack_require__(38),
...
var asciiToArray = __webpack_require__(93),
    hasUnicode = __webpack_require__(38),
    unicodeToArray = __webpack_require__(94);
...
var capitalize = __webpack_require__(98),
...
var _sortBy2 = __webpack_require__(106);
...
exports.default = function (Artboards) {
  var option = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
    marginX: 50,
    marginY: 100,
    reorder: true,
  ...
  var sortedArtboards = (0, _sortBy3.default)(Artboards, ['frame.y', 'frame.x']);
  var minX = (0, _sortBy3.default)(Artboards, ['frame.x'])[0].frame.x;
  var ArtboardsGroup = {};

  console.log('Sort Start');

  // add order number
  if (option.addNum) (0, _number.addNumber)(sortedArtboards, option.addNum);

  console.log('Add Num');

  (0, _forEach3.default)(sortedArtboards, function (layer) {
    // set layer order
    if (option.reorder) layer.moveToBack();

    // set rect
    if (option.sort) {
      var isFirstGroup = Object.keys(ArtboardsGroup).length === 0;
      ...
      if (!ArtboardsGroup[Y]) {
        ...
        if (!isFirstGroup) {
          var index = Object.keys(ArtboardsGroup).length - 1;
          var preGroupKey = Object.keys(ArtboardsGroup)[index - 1];
          var preGroup = ArtboardsGroup[preGroupKey];
          ArtboardsGroup[Y].index = index;
          ArtboardsGroup[Y].y = preGroup.y + preGroup.maxHeight + parseFloat(option.marginY);
        }
      }

      var Group = ArtboardsGroup[Y];
      var rect = new _dom.Rectangle(layer.frame);
      if (rect.height > Group.maxHeight) Group.maxHeight = rect.height;
      if (!isFirstChild) {
        var LastChild = (0, _last3.default)(Group.children).frame;
...
var prepareValue = __webpack_require__(101)

module.exports.toArray = __webpack_require__(40)
module.exports.prepareStackTrace = __webpack_require__(39)
...
/* eslint-disable no-not-accumulator-reassign/no-not-accumulator-reassign, no-var, vars-on-top, prefer-template, prefer-arrow-callback, func-names, prefer-destructuring, object-shorthand */
var prepareStackTrace = __webpack_require__(39)
...
var baseFlatten = __webpack_require__(107),
    baseOrderBy = __webpack_require__(109),
